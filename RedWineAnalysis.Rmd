...
From earlier it was found high 'alcohol' coincides with higher 'quality' wines, but what factors influence 'alcohol'?
...
ggplot(aes(x = alcohol, y = density), data = redwines) +
  ...
  scale_color_manual(values = c('(2,5]' = 'skyblue', '(5,8]' = 'maroon'), name = 'quality', labels = c('low', 'high'))
```

The graph above details density vs alcohol. Please note the transition from density
...
A first look at density vs. quality showcases a graph with a low correlation coefficient of -0.175 and values that appear to range all over the board. 
