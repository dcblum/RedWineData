...
The main feature of the analysis is quality. All variables need to be compared
to quality to determine what makes a 'high quality' wine.
...
postive correlation with alcohol (blue). Let's inspect those further.
...
as well as sulphates (next highest correlation with quality).
...
Minor significance can be found with citric.acid and sulphates.
