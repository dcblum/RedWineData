...
grid.arrange(p.fixed.acidity, p.volatile.acidity, p.citric.acid, p.residual.sugar, p.chlorides, p.free.sulfur.dioxide, p.total.sulfur.dioxide, p.density, p.pH, p.sulphates, p.alcohol, ncol = 4)
```
